...
import (
	...
	"github.com/CryptoLarry/ssm/database/postgres/migrations"
)
...
// ErrAlreadyExists is for when a TXID address combo already exist in DB
var ErrAlreadyExists = errors.New("Secure memo already exist for TXID-Address")
